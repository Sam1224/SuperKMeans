...
const std::map<std::pair<size_t, size_t>, float> GROUND_TRUTH = {
    ...
    {{100, 32}, 4.56025e+08f},
    {{100, 64}, 1.08228e+09f},
    {{100, 100}, 1.78985e+09f},
    {{100, 128}, 2.31452e+09f},
    {{100, 384}, 7.29032e+09f},
    {{100, 512}, 9.78623e+09f},
    {{100, 600}, 1.15701e+10f},
    {{100, 768}, 1.48647e+10f},
    // k=250
    {{250, 4}, 3.76537e+06f},
    {{250, 16}, 9.56419e+07f},
    {{250, 32}, 2.70247e+08f},
    {{250, 64}, 6.76442e+08f},
    {{250, 100}, 1.15054e+09f},
    {{250, 128}, 1.48841e+09f},
    {{250, 384}, 4.90202e+09f},
    {{250, 512}, 6.51145e+09f},
    {{250, 600}, 7.72274e+09f},
    {{250, 768}, 9.78821e+09f},
};
// clang-format on

...
const std::map<std::pair<size_t, size_t>, float> GROUND_TRUTH = {
    ...
    {{100, 32}, 5.11558e+06f},
    {{100, 64}, 1.04715e+07f},
    {{100, 100}, 2.00558e+07f},
    {{100, 128}, 2.47914e+07f},
    {{100, 384}, 9.12551e+07f},
    {{100, 512}, 1.33132e+08f},
    {{100, 600}, 1.44538e+08f},
    {{100, 768}, 1.98101e+08f},
    // k=250
    {{250, 4}, 3.03055e+04f},
    {{250, 16}, 2.14890e+05f},
    {{250, 32}, 3.00946e+05f},
    {{250, 64}, 6.12809e+05f},
    {{250, 100}, 9.64015e+05f},
    {{250, 128}, 1.23873e+06f},
    {{250, 384}, 3.74034e+06f},
    {{250, 512}, 4.99025e+06f},
    {{250, 600}, 5.85136e+06f},
    {{250, 768}, 2.09736e+07f}
};
// clang-format on
